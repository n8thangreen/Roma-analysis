...
mi estimate: logit  screening_initiative community_support_n discrimination_ethnicity sample  community_support_ni health_insurance female age no_educ afford_n   i.health_self  disability  walking_healthfacility  i.country $type_neighbourhood  i.asset_index i.percentage_of_roma , vce(cluster municipality_n)
